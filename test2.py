...
class Application:
    ...
    def __init__(self):
        self.url = 'http://192.168.12.22/cam-hi.jpg'
        self.vs = cv2.VideoCapture(self.url)
        self.current_image = None
        self.model = tf.keras.models.load_model('C:\\Users\\mfaha\\Downloads\\Sign-Language-To-Text-and-Speech-Conversion-master\\Sign-Language-To-Text-and-Speech-Conversion-master\\LSTM_model.h5')
    ...
    def video_loop(self):
        try:
            ...
            if hands:
                ...
                white = cv2.imread("C:\\Users\\mfaha\\Downloads\\Sign-Language-To-Text-and-Speech-Conversion-master\\Sign-Language-To-Text-and-Speech-Conversion-master\\white.jpg")
