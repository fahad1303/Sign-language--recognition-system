...
model = tf.keras.models.load_model('C:\\Users\\mfaha\\Downloads\\Sign-Language-To-Text-and-Speech-Conversion-master\\Sign-Language-To-Text-and-Speech-Conversion-master\\cnn8grps_rad1_model.h5')
...
while True:
    try:
        ...
        hands, frame = hd.findHands(frame,flipType= False)
        print(frame.shape)
        if hands:
            ...
            handz, frame = hd.findHands(frame,flipType=False)
            if handz:
                hand = handz[0]
                pts = hand['lmList']
