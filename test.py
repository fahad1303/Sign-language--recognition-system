...
from tkinter import PhotoImage,Label,messagebox,Canvas
...
class Application:
    ...
    def __init__(self):
        ...
        self.model = tf.keras.models.load_model('C:\\Users\\mfaha\\OneDrive\\Desktop\\Sign-Language-Reconition-System\\LSTM_model.h5')
        ...
        self.root = tk.Tk()
        self.root.title("Sign Language Recognition Systemm")
        ...
        background_label.place(x=0, y=0, relwidth=1, relheight=1)  # Stretch the label to fill the window
        
        self.panel = tk.Label(self.root)
        self.panel.place(x=300, y=150, width=350, height=350)

        self.panel2 = tk.Label(self.root)  # initialize image panel
        self.panel2.place(x=750, y=150, width=350, height=350)

        self.T = tk.Label(self.root)
        self.T.place(x=80, y=10)
        self.T.config(text="Sign Language Recognition System", font=("Courier", 30, "bold"))

        self.panel3 = tk.Label(self.root)  # Current Symbol
        self.panel3.place(x=280, y=585,width=480, height=50)
        ...
        self.panel5.place(x=260, y=632, width=500,height=50)
    ...
    def video_loop(self):
        try:
            ...
            #hands, cv2image = hd.findHands(cv2image)
            ...
            if hands:
                ...
                white = cv2.imread("C:\\Users\\mfaha\\OneDrive\\Desktop\\Sign-Language-Reconition-System\\white.jpg")
                # img_final=img_final1=img_final2=0

                handz,cv2image = hd2.findHands(image, draw=True, flipType=True)
                #handz, cv2image = hd2.findHands(cv2image)
                print(" ", self.ccc)
                self.ccc += 1
                if handz:
                    hand = handz[0]
